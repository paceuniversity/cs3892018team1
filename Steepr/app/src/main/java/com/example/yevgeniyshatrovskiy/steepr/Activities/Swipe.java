...
public class Swipe extends ItemTouchHelper.Callback {
    ...
    private SwipeActions buttonsActions = null;
    ...
    public Swipe(SwipeActions buttonsActions) {
        ...
        recyclerView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    Swipe.super.onChildDraw(c, recyclerView, viewHolder, 0F, dY, actionState, isCurrentlyActive);
                    recyclerView.setOnTouchListener(new View.OnTouchListener() {
                        @Override
                        public boolean onTouch(View v, MotionEvent event) {
                            return false;
    ...
    private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
        ...
        Paint p = new Paint();
//        Log.v("XXXXA", " : "+viewHolder.getAdapterPosition());
//        Log.v("XXXXI", " : "+viewHolder.getItemId());
        Log.v("XXXXL", " : " + viewHolder.getLayoutPosition());
//        Log.v("XXXX", " : "+recipes.get(viewHolder.getOldPosition()).getName());

        if(viewHolder.getLayoutPosition() > -1)
            for(Recipe rep : recipes){
//                rep.getName();
                Log.v("FIX", rep.getName());
        }
//            Log.v("-----", recipes.toString());
    ...
    public void onDraw(Canvas c, ArrayList<Recipe> rep) {
        recipes = rep;
